...
class KalmanFilterXYAH:
    ...
    contains the bounding box center position (x, y), depth z, aspect ratio a, height h,
    ...
    def initiate(self, measurement):
        ...
        ----------
        measurement : ndarray
            Bounding box coordinates (x, y, z, a, h) with center position (x, y), depth z,
        ...
        std = [
            ...
            2 * self._std_weight_depth * measurement[3], 1e-2,
    ...
    def predict(self, mean, covariance):
        ...
        """
        std_pos = [
            self._std_weight_position * mean[3], self._std_weight_position * mean[3], self._std_weight_depth * mean[3],
            1e-2, self._std_weight_position * mean[3]]
        std_vel = [
            self._std_weight_velocity * mean[3], self._std_weight_velocity * mean[3], self._std_weight_velocity * mean[3],
    ...
    def project(self, mean, covariance):
        ...
        std = [
            ...
            self._std_weight_depth * mean[3], 1e-1, self._std_weight_position * mean[3]]
    ...
    def update(self, mean, covariance, measurement):
        ...
        measurement : ndarray
            The 5 dimensional measurement vector (x, y, z a, h), where (x, y)
            is the center position, z depth, a the aspect ratio, and h the height of the
            bounding box.
